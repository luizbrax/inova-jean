...
// === TRECHO QUE VOCÊ PEDIU ADAPTADO AO SEU CÓDIGO ===
document.addEventListener('DOMContentLoaded', () => {
    ...
    dias.forEach(dia => {
        dia.addEventListener('click', () => {
            ...
            const mesAtual = document.getElementById('current-month').textContent; // exemplo: "outubro 2025"
            ...
            const [nomeMes, ano] = mesAtual.split(' ');
            const mesNumero = meses[nomeMes.toLowerCase()];

            const dataFormatada = `${ano}-${mesNumero}-${diaSelecionado.padStart(2, '0')}`;
